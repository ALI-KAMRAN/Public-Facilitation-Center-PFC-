...
class clientathuntication extends Controller
{
...
$this->validate($req,['contact'=>'required|digits:12'],[
  ...
  'contact.numeric' => 'Number Must Be digit 11 ',
...
$this->validate($req, ['file' => 'image|mimes:jpeg,png,jpg,gif,svg',]);
             ...
             $lawyer->comment=$req->comment;
             $lawyer->save();

             return view("client_login")->withErrors(['Your form is submitted successfully Please login Niw']);
