...
$this->validate($req,['gender'=>'required'],[

  'gender.required'=> ' not be empty',
...
$this->validate($req, ['file' => 'image|mimes:jpeg,png,jpg,gif,svg',]);
   ...
   return view("lawyerpage.adminlogin")->withErrors(['Yor form is submited successfuly Please login Now']);

    }
    public function abc()
    {
      return view('lawyerpage.adminsignup');
    }
}
