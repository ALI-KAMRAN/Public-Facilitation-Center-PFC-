...
<form class="form-design" action="{{action('charactercontroller@store')}}" method="post" enctype="multipart/form-data">
<center><h2>Online Character Certificate</h2></center>
<br><br>
...
<h5><label for="exampleFormControlInput1">Applicant Pic</label></h5> 
    ...
    <div class="col">
    <h5> <label for="exampleFormControlInput1">Passport #</label></h5> 
      <input type="text" class="form-control" placeholder="Applicant Passport #" name="passport_#">
    </div>
...
<div class="form-check">
  ...
  <div class="row">
    <div class="col">
    <h5><label for="exampleFormControlInput1">From (Required Certificate)</label></h5> 
      <input type="date" class="form-control"  name="from">
    </div>
    <div class="col">
    <h5> <label for="exampleFormControlInput1">TO</label></h5> 
  ...
  <div class="row">
    ...
    <div class="form-check">
  <input class="form-check-input" type="checkbox" name="purpose" value="Job Purpose" id="defaultCheck1" >
...
<div class="form-check">
  <input class="form-check-input" type="checkbox" value="Abroad Purpose" name="purpose"  id="defaultCheck1">
  <label class="form-check-label" for="defaultCheck1">
    Abroad Purpose
  </label>
</div>
...
<div class="col">
<h5> <label for="exampleFormControlInput1">Select Polie Station</label>
...
<div class="row">
<div class="col">
<h5><label for="exampleFormControlInput1">Applicant CNIC Front & Back Pic</label></h5> 
...
<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target=".bd-example-modal-lg">
  Learn how to Apply online Character Certificate!
</button>
</form>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/-Ci7A9Zh-ts" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
