...
<form class="form-design" action="{{action('vehiclecontroller@store')}}" method="post" enctype="multipart/form-data">
<center><h2>Online Vehicle Verification</h2></center>
<br><br>
...
<br>
  ...
  <div class="row">
    <div class="col">
    <h5><label for="exampleFormControlInput1">Vehicle Number</label></h5> 
      <input type="text" class="form-control" placeholder="GAK 157 etc" name="vehicle_no">
    </div>
    <div class="col">
    <h5> <label for="exampleFormControlInput1">Vehicle Detail</label></h5> 
      <input type="text" class="form-control" placeholder="Model,Engine Number Etc" name="vehicle_detail">
    </div>
  </div>
...
<div class="row">
<div class="col">
<h5><label for="exampleFormControlInput1">Applicant CNIC $ Vehicle Original Documents Front & Back Pic</label></h5> 
...
<button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target=".bd-example-modal-lg">
  Learn how to Registration online Vehicle Verification!
</button>
</form>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/faZ-aqlTZV0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
