...
<form class="form-design" action="{{action('vehicleStatusC@update',$id)}}" method="post">
<center><h2>Enter Vehicle Verification Status</h2></center>
<br><br>
...
<label for="exampleInputEmail1"><b> Select Vehicle Verification Status </b> </label>
...
<br><br>
 <div class="form-group">
    <label for="exampleInputEmail1"><b> Character Vehicle Verification Date </b> </label>
