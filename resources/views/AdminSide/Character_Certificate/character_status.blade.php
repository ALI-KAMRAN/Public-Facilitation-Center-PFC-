...
<form class="form-design" action="{{action('characterStatusC@store')}}" method="post" >
<center><h2>Checked Character Certificate Status</h2></center>
<br><br>
...
@csrf
  ...
  <h5> <label for="exampleFormControlInput1">Applicant CNIC</label></h5> 
      <input type="text" value="{{$student->cnic}}" class="form-control" placeholder="Applicant CNIC" name="cnic">
    </div>
