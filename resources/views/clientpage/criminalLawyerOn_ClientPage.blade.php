...
<body class="host_version"> 
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown" id="lawyer">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown-a">
                <a class="dropdown-item active" href="/laravel/public/clientindex/criminallawyer" id="lawyer">Criminal Lawyer </a>
  ...
  <!-- End header -->
	...
	<div id="teachers" class="section wb">
      ...
      @foreach($clawyer as $clawyer)
		<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team" >
						<div class="team-img" >
					<img src="{{URL::to('/')}}/storage/upload/{{$clawyer->image}}"  > 
							<div class="social">
								<ul>
						...
						<a href="{{URL::to('/')}}/clientindex/criminallawyer/lawyerprofileview/{{$clawyer->id}}" <h3 class="title">{{$clawyer->name}}</h3></a>
