...
<div class="container ">
<h2 class="text-center">Client Profile UpDate</h2>
<form action="{{URL::to('/')}}/clientindex/clientprofileupdateformsunmit/{{$dat[0]->id}}" method="post" enctype="multipart/form-data">
         @csrf
  <div class="row p-2">
      <div  class="col-sm-6  text-light">
       ...
       <input type="text" class="form-control" name="firstname" value={{$dat[0]->name}}>
     </div>
      ...
      <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" name="lastname" value={{$dat[0]->lname}}>
     </div>
      </div>
  </div>
   <div class="row p-2">
     <div class="col-sm-8 text-light">
       ...
       <input type="text" class="form-control" name="e_mail" value={{$dat[0]->email}} >
     </div>
 ...
 <div class="row p-2">
     <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" name="password" value={{$dat[0]->password}} >
     </div>
      ...
      <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" name="password_conformation" value={{$dat[0]->conpassword}} >
     </div>
...
<div class="row p-2">
     <div class="col-sm-6 text-light">
       ...
       <input type="number" class="form-control" name="contact" value={{$dat[0]->contact}} >
     </div>
      ...
      <div class="col-sm-6 text-light">
       ...
       <select  class="form-control" name="education" value={{$dat[0]->education}}>
         <option>LLB</option>
         <option>LLM</option>
...
<div class="row p-2">
    <div class="col-sm-6 text-light">
       ...
       <div class="form-group">
       <label>City:</label><br>
       <select  class="form-control"  name="city" value={{$dat[0]->city}}>
      ...
      <div class="col-sm-6 text-light">
       ...
       <select  class="form-control" name="country" value={{$dat[0]->country}}>
...
<div class="row p-2">
    <div class="col-sm-8 text-light">
       ...
       <select  class="form-control" name="gender" value={{$dat[0]->gender}}>
         <option>Male</option>
    ...
    <div class="col-sm-6 text-light">
      ...
      <input type="date"name="birth" class="form-control" value={{$dat[0]->birth}}>
     </div>
      ...
      <div class="col-sm-6 text-light">
       ...
       <div class="form-group">
       <label>Want Lawyer_Type:</label><br>
       <select  class="form-control" name="age" value={{$dat[0]->age}}>
  ...
  <input type="file" id="myfile"name="pic"   value={{$dat[0]->image}}>
    ...
    <div class="col-sm-12 text-light">
      ...
      <textarea class="form-control p-4" name="comment" value={{$dat[0]->comment}}></textarea>
