...
<body class="host_version"> 
        ...
        <div class="collapse navbar-collapse" id="navbars-host" >
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown" id="lawyer">
              <a class="nav-link dropdown-toggle active" href="#" id="dropdown-a" data-toggle="dropdown" id="lawyer">Lawyers</a>
              <div class="dropdown-menu " aria-labelledby="dropdown-a">
                <a class="dropdown-item" href="/laravel/public/clientindex/criminallawyer" id="lawyer">Criminal Lawyer </a>
                <a class="dropdown-item active" href="/laravel/public/clientindex/familylawyer" id="lawyer">Family Lawyer </a>
  ...
  <!-- End header -->
	...
	<div id="teachers" class="section wb">
      ...
      @foreach($flawyer as $flawyer)
		<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team" >
						<div class="team-img" >
					<img src="{{URL::to('/')}}/storage/upload/{{$flawyer->image}}"  > 
							<div class="social">
								<ul>
						...
						<a href="{{URL::to('/')}}/clientindex/familylawyer/lawyerprofileview/{{$flawyer->id}}" <h3 class="title">{{$flawyer->name}}</h3></a>
