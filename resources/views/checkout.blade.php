...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="{{URL::to('/')}}/images/court_pic.jpg" alt="New products" >
				<h4><span>Offline Check Out</span></h4>
			</section>
			<section class="main-content">				
				<div class="row">
				
					<div class="span9">					
						<h4 class="title"><span class="text"><strong>Offline Check</strong> Out</span></h4>
...
<div class="row">
<div class="col">
<h5><label for="exampleFormControlInput1"><h5>Upload Applicant Signature & thumb impression Pic</h5></label></h5> 
...
<br><br><center>
<button type="submit" class="btn btn-primary">Conform Order Offline</button>
