...
<div class="container" >
<h2 class="text-center">Client SignUp Form</h2>
<form action="{{URL::to('/index/clientsignup/athuntication')}}" method="post" enctype="multipart/form-data">
         @csrf
  <div class="row p-2">
      <div  class="col-sm-6  text-light">
       ...
       <input type="text" class="form-control" style="height:40px;" name="firstname" placeholder="Enter your name..." >
     </div>
...
<div class="row p-2">
    ...
    <div class="col-sm-6 text-light">
      ...
      <input type="date"name="birth" style="height:40px;" class="form-control">
     </div>
  ...
  <input type="file" id="myfile"name="image"  >
    ...
    <div class="col-sm-12 text-light">
      ...
      <textarea class="form-control p-4" name="comment"></textarea>
