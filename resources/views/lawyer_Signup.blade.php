...
<div class="container ">
<h2 class="text-center">Lawyer SignUp Form</h2>
<form action="{{URL::to('/index/lawyersignup/athuntication')}}" method="post" enctype="multipart/form-data">
         @csrf
  <div class="row p-2">
