...
<div class="container ">
<h2 class="text-center">Lawyer Profile UpDate</h2>
<form action="{{URL::to('/')}}/lawyerindex/lawyerprofileupdateformsunmit/{{$data[0]->id}}" method="post" enctype="multipart/form-data">
         @csrf
  <div class="row p-2">
