...
<form action="{{URL::to('')}}/updatesubmit/{{$data[0]->id}}" method="post" enctype="multipart/form-data">
         @csrf
  <div class="row p-2">
      ...
      <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" style="height:40px;" name="lastname" value={{$data[0]->lname}} >
     </div>
      </div>
  </div>
   <div class="row p-2">
     <div class="col-sm-8 text-light">
       ...
       <input type="text" class="form-control" style="height:40px;" name="e_mail" value={{$data[0]->email}} >
     </div>
 ...
 <div class="row p-2">
     <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" style="height:40px;" name="password" value={{$data[0]->password}} >
     </div>
      ...
      <div class="col-sm-6 text-light">
       ...
       <input type="text" class="form-control" style="height:40px;" name="password_conformation" value={{$data[0]->password}}>
     </div>
...
<div class="row p-2">
     <div class="col-sm-6 text-light">
       ...
       <input type="number" class="form-control" style="height:40px;" name="contact" value={{$data[0]->contact}} >
     </div>
...
<div class="row p-2">
   ...
   <div class="row p-2">
    <div class="col-sm-6 text-light">
      ...
      <input type="file" id="img" name="image" value={{$data[0]->image}} accept="image/*">
