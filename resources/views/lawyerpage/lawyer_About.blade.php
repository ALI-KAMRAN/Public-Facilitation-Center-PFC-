   ...
   <!-- Start header -->
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host" >
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="{{URL::to('/')}}lawyerindex/about">About Us</a></li>
						<li class="nav-item dropdown" id="lawyer">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="{{URL::to('/')}}/awyerindex/familylawyer" id="lawyer">Family Lawyer </a>
								<a class="dropdown-item" href="{{URL::to('/')}}/lawyerindex/immigrationlawyer" id="lawyer">Immigration Lawyer</a>
							</div>
						</li>
						
						<li class="nav-item "><a class="nav-link" id="client" href="{{URL::to('/')}}/lawyerindex/clients">Clients</a></li>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>About Us<span class="m_1">There Are Three Persons Who develop this Awesome Website.</span></h1>
		</div>
	</div>
