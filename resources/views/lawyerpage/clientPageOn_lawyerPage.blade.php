...
<body class="host_version"> 
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown" id="lawyer">
							...
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="{{URL::to('/')}}/lawyerindex/public/immigrationlawyer" id="lawyer">Immigration Lawyer</a>
							</div>
						</li>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>client Page<span class="m_1">Welcome to our client Page.</span></h1>
		</div>
	</div>
	...
	<div id="teachers" class="section wb">
      ...
      @foreach($client as $client)
		<div class="col-lg-3 col-md-6 col-12">
					<div class="our-team">
						<div class="team-img">
						<img src="{{URL::to('/')}}/storage/upload/{{$client->image}}"  > 
							<div class="social">
								<ul>
						...
						<a href="{{URL::to('/')}}/lawyerindex/clients/clientprofileview/{{$client->id}}" ><h3 class="title"> {{$client->name}}</h3></a>
